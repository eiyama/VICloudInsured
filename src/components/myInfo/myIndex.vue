  ...
  <div class="home">
    ...
    <div class="mt-my-list">
      <div class="head-area fn-clear" >
        <div>
           <!-- 条件1？值1:条件2？值:值3 -->
          <img class="ico-head" :src="weixinInfor.headimgUrl ? weixinInfor.headimgUrl : headImageUrl ? headImageUrl : avatar" alt=""  @click="uploadHeadImg">
          <input type="file" accept="image/*" @change="handleFile" class="hiddenInput" />
        </div>
        <div class="head-info" @click="modify" >
          <div style="display:flex;">
            <h2>{{weixinInfor.nickname ? weixinInfor.nickname : accountName ? accountName : userName}}</h2> 
             <div style="position: absolute; right: 0px;">
               <div class="weixinIconBox"  v-if="hasBindWeixin" v-show="enableLogin" >
                ...
                <div @click.stop="toZxcertification" v-show="authStatus == 'UnAuth' && isEnabledAuth && isZxbtn" class="head-RightBtn">
                     <p style="margin-right:5px;">未实名认证</p> 
                     <van-icon name="arrow" />
                </div>
                <div v-show="(authStatus == 'Pending' || authStatus == 'PassAuth') && isEnabledAuth && isZxbtn" class="authenticated">
...
export default {
  ...
  created: function() {
    ...
    this.hasEnquiryProducts = (appId == 'cx7190761141531rzi' || appId == 'cxa181211170855pxj' ||  appId == 'cx8190110143618pyi' || appId == 'cxs190103104249iwe' || appId == 'cx7190408201251bh0' );
  ...
  methods: {
    ...
    myQr: function() {
      var nickName = this.weixinInfor.nickname  || this.accountName || this.userName;
