  ...
  <div class="vehicleInfo" style="background-color:#FFF">
    ...
    <div class="mint-region">
      ...
      <mt-field label="车架号" class="upper" type="text" placeholder="请输入车架号" v-model="carInfoData.car.vin">
        <van-button size="small" style="color:#4A66FE;border:1px solid #4A66FE;margin-left:5px;border-radius:8px;" plain @click="openPriceModelBoxByVin">查车型</van-button>
      </mt-field>
      <hr width="100%" color="#f5f5f5" size="1">
    ...
    <van-popup v-model="show" style="background-color:rgba(255, 255, 255, 0)" closeable>
